return {
  ...
  { 'nvim-telescope/telescope-fzf-native.nvim', build = 'make', cond = vim.fn.executable 'make' == 1 },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', "<leader>g", require('telescope.builtin').git_status, { desc = "[g] Changed files" })
